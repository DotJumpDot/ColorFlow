<template>
  <div>
    ...
    <section style="background-color: #f5f5f5; padding: 20px; margin: 10px">
      ...
      <p style="background-color: #ffcccc">This has red background color</p>
      <p style="background-color: #ccffcc">This has green background color</p>
      <p style="background-color: #ccccff">This has blue background color</p>
      <p style="background-color: #ffffcc">This has yellow background color</p>
      <p style="background-color: #ffccff">This has magenta background color</p>
      <p style="background-color: #ccffff">This has cyan background color</p>
    </section>

    <!-- SECTION 7: Both Color and Background Color -->
    <section style="background-color: #f5f5f5; padding: 20px; margin: 10px">
      <h1>Both Color and Background Color</h1>
      <p style="color: white; background-color: #ff0000">White text on red background</p>
      <p style="color: white; background-color: #00ff00">White text on green background</p>
      <p style="color: white; background-color: #0000ff">White text on blue background</p>
      <p style="color: black; background-color: #ffff00">Black text on yellow background</p>
      <p style="color: white; background-color: #ff00ff">White text on magenta background</p>
      <p style="color: black; background-color: #00ffff">Black text on cyan background</p>
    </section>
    ...
    <section style="background-color: #f5f5f5; padding: 20px; margin: 10px">
      ...
      <section style="background-color: purple; color: white">
      ...
      <section style="background-color: #333; color: #fff">
    ...
    <section style="background-color: #f5f5f5; padding: 20px; margin: 10px">
      ...
      <p style="color: #333">
        This is a longer paragraph of text to test how the Color Flow extension handles longer text
        spans with inline styles. The extension should properly highlight the entire text range with
        the specified color. This allows users to visualize the color of text in their HTML
        documents with configurable background highlighting. The extension supports various color
        formats including hex, rgb, rgba, hsl, hsla, and color names.
      </p>
      <p style="color: #666">
        Another paragraph with different color. This text is gray and demonstrates that the
        extension can handle multiple paragraphs with different colors within the same section. Each
        paragraph should be highlighted according to its own color property. The extension parses
        HTML documents using htmlparser2 and tracks accurate positions for precise range
        calculation.
      </p>
    </section>
    ...
    <section style="background-color: #f5f5f5; padding: 20px; margin: 10px">
      ...
      <p style="color: green; font-size: 18px; text-decoration: underline">
        Green underlined text with 18px font size
      </p>
      <p style="color: red; font-style: italic; letter-spacing: 1px">
        Red italic text with letter spacing
      </p>
      <p style="color: purple; line-height: 1.5; text-align: center">
    ...
    <section style="background-color: #f5f5f5; padding: 20px; margin: 10px">
      ...
      <p style="background-color: #ffcccc">Text with red background (no border radius)</p>
