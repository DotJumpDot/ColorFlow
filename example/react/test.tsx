    ...
    <div>
      ...
      <section style={{ backgroundColor: '#f5f5f5', padding: '20px', margin: '10px' }}>
        ...
        <p style={{ color: '#333' }}>
          ...
          spans with inline styles. The extension should properly highlight the entire text range
          with the specified color. This allows users to visualize the color of text in their HTML
